			...
			<div class="content">
				<dl class="company_center_content">
					...
					<dd>
						...
						<form action="addPosition.do" method="post" id="jobForm">
						<input type="hidden" value='${sessionScope.loginfirm.firm_id}' name="p_firmid" id="p_firmid">
						
						<input type="hidden" value='addPosition' name="flag" id="flag">
							<table class="btm">
								<tbody>
									<tr>
										...
										<td width="85">职位类别</td>
										<td>
										<input type="hidden" id="positionType" value=""name="positionType"> <input type="button"value="请选择职位类别" id="select_category"class="selectr selectr_380">
							...
							<table class="btm">
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="salary_range">
												<input type="text"  list="salarycours"  placeholder="月薪" autocomplete="off" name="p_salary" id="p_salary">
									...
									<tr>
										<td><span class="redstar">*</span></td>
										<td>工作城市</td>
										<td><input type="text"  list="citycours"  placeholder="工作城市" autocomplete="off" id="p_address" name="p_address">
							...
							<table class="btm">
								<tbody>
									<tr>
										<td width="25"><span class="redstar">*</span></td>
										<td width="85">职位诱惑</td>
										<td><input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" value=""name="p_welfare"id="p_welfare"></td>
									</tr>
									<tr>
										<td><span class="redstar">*</span></td>
										<td>职位描述</td>
										<td><span class="c9 f14">(建议分条描述工作职责等。请勿输入公司邮箱、联系电话及其他外链，否则将自动删除)</span>
												<textarea rows="" cols="" required="required" id="p_info" name="p_info"></textarea>
										</td>
									</tr>
									<tr>
										<td><span class="redstar">*</span></td>
										...
										<td><span class="c9 f14"></span>
												<textarea rows="" cols="" required="required" id="p_require" name="p_require"></textarea>
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table>
								<tbody>
									<tr>
										<td width="25"><span class="redstar">*</span></td>
										<td colspan="2">接收简历邮箱： 
										<input type="email" style="height: 25px;" id="p_email" name="p_email" placeholder="填入 邮箱" required="required"/>
										</td>
									</tr>
									<tr>
										<td width="25"><span class="redstar">*</span></td>
										<td colspan="2">联系电话： 
										<input type="tel" style="height: 25px;" id="p_tel" name="p_tel" placeholder="填入联系电话" required="required"/>
										</td>							
									</tr>
									<tr>
										<td width="25"></td>
