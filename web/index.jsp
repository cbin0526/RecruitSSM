...
<body>
	<div id="body">
        ...
        <input type="text" id="search_input" name = "key"  tabindex="1" value=""  placeholder="请输入职位名称，如：产品经理"  />
...
.ui-menu-item a {
 ...
 -->
	...
	<div id="footer">
		<div class="wrapper">
			<a href="about.html" target="_blank" rel="nofollow">联系我们</a> <a
				href=https://weibo.com/u/5704043792 target="_blank" rel="nofollow">奇迹才聘微博</a>
			<a class="footer_qr" href="javascript:void(0)" rel="nofollow">奇迹才聘微信<i></i></a>
			<div class="copyright">
				&copy;2018-2020 QiJiCaiPin <a target="_blank"
