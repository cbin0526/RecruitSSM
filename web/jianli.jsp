  		...
  		<div class="clearfix">
            <div class="content_l">
            			...
            			<input type="hidden" name="flag" value="updateCustomer">
						  <table>
						    <tbody><tr>
						      ...
						      <td>
						        <input type="text" placeholder="姓名" value="${logincustomer.u_username}" name="name" >
						      </td>
			    ...
			    <tr>
						      ...
						      <td colspan="3">
						          <input type="text" placeholder="手机号码" value="${logincustomer.u_tel}" name="tel" >
						      </td>
						   	</tr>
						   	<tr>
						      <td valign="top">
						      ...
						      <td colspan="3">
						          <input type="text" placeholder="接收面试通知的邮箱" value="${logincustomer.u_email}" name="email" >
						      </td>
						    </tr>
						    <tr>
						      <td valign="top"> </td> 
...
function myajax(page,size){
	  ...
	  $.ajax({
		 ...
		 success: function(msg){
			...
			"            		\r\n" + 
			"            	 <div class=\'basicShow\'>\r\n" + 
			"            			            			<span>"+msg.msgobject.recordlist[i].r_name+" |  "+msg.msgobject.recordlist[i].r_sex+" |   "+msg.msgobject.recordlist[i].r_workedyear+" |"+ msg.msgobject.recordlist[i].r_graduation+" <br>\r\n" +msg.msgobject.recordlist[i].r_tel+ 
