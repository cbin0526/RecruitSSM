...
<title>发布新职位-招聘服务-奇迹才聘网-最专业的互联网招聘平台</title>
		...
		<div id="container">
			...
			<div class="sidebar">
				...
				<div class="subscribe_side mt20">
					...
					<div class="f18 mb10">就用奇迹才聘招聘加速助手</div>
					<div>
							...
							<table class="btm">
								<tbody>
									<tr>
										...
										<td width="85">职位类别</td>
										<td>
										<input type="hidden" id="positionType" value="${position.p_type}"name="positionType"> <input type="button"value="${position.p_type}" id="select_category"class="selectr selectr_380">
									...
									<tr>
										...
										<td><input type="text" placeholder="请输入职位名称，如：产品经理"
											value="${position.p_name}" name="positionName" id="positionName"></td>
									</tr>
							...
							<table class="btm">
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="salary_range">
												<input type="text" value="${position.p_salary}" list="salarycours"  placeholder="月薪" autocomplete="off" name="p_salary" id="p_salary">
												<datalist id="salarycours">
													<option>2k-5k</option>
									...
									<tr>
										<td><span class="redstar">*</span></td>
										<td>工作城市</td>
										<td><input type="text" value="${position.p_address}" list="citycours"  placeholder="工作城市" autocomplete="off" id="p_address" name="p_address">
												<datalist id="citycours">
													<option>厦门市</option>
													<option>福州市</option>
													<option>三明市</option>
													<option>宁德市</option>
							...
							<table class="btm">
								<tbody>
									<tr>
										<td width="25"><span class="redstar">*</span></td>
										<td width="85">工作经验</td>
										<td><input type="hidden" id="experience" value="${position.p_wexperience}"
											name="workYear"> <input type="button" value="${position.p_wexperience}"
									...
									<tr>
										...
										<td>学历要求</td>
										<!--<h3><span>(最高月薪不能大于最低月薪的2倍)</span></h3> -->
										<td><input type="hidden" id="education" value="${position.p_graduation}"
											name="education"> <input type="button"
											value="${position.p_graduation}" id="select_education"
							...
							<table class="btm">
								<tbody>
									<tr>
										<td width="25"><span class="redstar">*</span></td>
										<td width="85">职位诱惑</td>
										<td><input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" value="${position.p_welfare}"name="p_welfare"id="p_welfare"></td>
									</tr>
									<tr>
										<td><span class="redstar">*</span></td>
										<td>职位描述</td>
										<td><span class="c9 f14">(建议分条描述工作职责等。请勿输入公司邮箱、联系电话及其他外链，否则将自动删除)</span>
												<textarea rows="" cols="" required="required" id="p_info" name="p_info">${position.p_info}</textarea>
										</td>
									</tr>
									<tr>
										<td><span class="redstar">*</span></td>
										<td>任职要求</td>
										<td><span class="c9 f14"></span>
												<textarea rows="" cols="" required="required" id="p_require" name="p_require">${position.p_require}</textarea>
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table>
								<tbody>
									<tr>
										<td width="25"><span class="redstar">*</span></td>
										<td colspan="2">接收简历邮箱： 
										<input type="email" value="${loginfirm.firm_email}" style="height: 25px;" id="p_email" name="p_email" placeholder="填入 邮箱" required="required"/>
										</td>
									</tr>
									<tr>
										<td width="25"><span class="redstar">*</span></td>
										<td colspan="2">联系电话： 
										<input type="tel" value="${loginfirm.firm_tel}" style="height: 25px;" id="p_tel" name="p_tel" placeholder="填入联系电话" required="required"/>
										</td>							
									</tr>
									<tr>
										<td width="25"></td>
