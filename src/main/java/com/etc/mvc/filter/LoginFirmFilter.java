 ...
 */
// �����Ҫ�˺ŵ������ܷ��ʵ�ҳ��
//@WebFilter(urlPatterns = {"/firmindex.jsp"})
public class LoginFirmFilter implements Filter {

    /**
     * Default constructor. 
     */
    public LoginFirmFilter() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		Firm c = (Firm)request1.getSession().getAttribute("loginfirm");
		// �ж�Customer�����Ƿ����
		if(c!=null) {
